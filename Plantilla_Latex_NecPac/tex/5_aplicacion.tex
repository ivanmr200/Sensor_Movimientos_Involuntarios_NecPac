...
El nombre de la aplicación surge de la combinación de dos conceptos. Por un lado, \textbf{"Involunt"}, siendo la abreviatura de involuntario, representando al tipo de movimientos que la aplicación pretende detectar. Por otro lado, \textbf{"Track"}, haciendo referencia a la trayectoria que realiza el usuario durante la prueba.

Se puede acceder a la aplicación desde el siguiente enlace:
\begin{itemize}
\item \url{https://involunttrack.streamlit.app/}
\end{itemize}
